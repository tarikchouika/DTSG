# مواصفة تصميم «الضومنة والطاولة» — مرجع مُلزِم (v2.46)
...
> `tests/_look_v246_test.js` (متصفح) وأن يُحدَّث هذا الملف. المستودع عام ⇒ لا أسرار هنا.
>
> آخر تحديث: 2026-09-20 (v2.46) — وكيل Arena.
...
| العنصر | القيمة | الملف |
|---|---|---|
| المرحلتان `#dmStage`/`#bwStage` | `position:absolute; inset:0` داخل `#gamePageBody` (بلا تحجيم transform) | `css/21-classic.css` §v2.46-FIT |
...
| مواضع اللاعبين | **بورتريه**: الخصم أعلى-يسار · الحالة وسطاً · أنا أعلى-يمين — **لاندسكيب**: الخصم أعلى-يسار الطاولة · أنا أسفل-يمين فوق اليد | `css/22-look.css` §v2.46-SEATS |
...
node tests/_look_v246_test.js              # حارس التصميم (بورتريه + لاندسكيب)
