...
const RULES = {
  ...
  /* [BL] قواعد البلوت المختصرة */
  bl: [['32 ورقة (7 → آس) وأربعة لاعبين على فريقين متقابلين — 8 أوراق لكل لاعب',
      'بعد التوزيع: إعلان أشفور اختياري — سرا 20 · خمسين 50 · مية 100 · رباعية (4J=200، 4 التسعات=150، 4 آس/عشرة/ملك/بنت=100) — الأعلى يقطع الأدنى',
  ...
  /* [UN] قواعد أونو المختصرة */
  un: [['108 بطاقة بأربعة ألوان (أحمر/أزرق/أخضر/أصفر): رقم 0-9 وأوراق تخطي S ورجوع R و+2 D و+4 X مع 8 براغي (W و+4)',
      'يوزع 7 لكل لاعب والبداية ببطاقة غير براغي — الطابق تطابق اللون أو الرقم أو براغي',
      'التخطي S يلغي دور التالي · الرجوع R يعكس الاتجاه · +2/+4 التالي يسحب ويلغي دوره',
      'بلا بطاقة قانونية؟ اسحب — إن كانت مفيدة العبها وإلا مرّر',
      'UNO: عند بقاياك بطاقة واحدة صوّح UNO — المنسى يسحب بطاقتين جزاءً',
      'الفوز: من يفوّت يده — نقاط الجولة = مجموع أوراق الخاسرين (أرقام=قيمتها، A=20، براغي=50) — أول من يبلغ الهدف (200/500/1000) يفوز',
      'الرهان: متاح فقط بين اللاعبين في الغرف الأونلاين — وضع البوت والوضع المحلي تعليمي مجاني بلا رهان']],
};
