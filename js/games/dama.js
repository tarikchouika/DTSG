    ...
    '<div class="dama-wrap" id="damaWrap">' +
      ...
      '<div class="dama-play" id="damaPlay" hidden>' +
        ...
        '<div class="dama-ctrls">' +
          '<button class="dama-mini dama-round" id="damaDrawBtn" onclick="damaDrawOffer()" title="' + T('dama.drawBtn') + '" aria-label="' + T('dama.drawBtn') + '"><svg class="dm-ico" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M3.1 12.4 7.2 8.3a2.5 2.5 0 0 1 3.5 0l1.3 1.3 1.3-1.3a2.5 2.5 0 0 1 3.5 0l4.1 4.1" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="m9.1 12.3 1.7 1.7a1.8 1.8 0 0 0 2.5 0l.5-.5" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="m6.9 14.5 2.1 2.1M9.5 16.6l1.9 1.9" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"/></svg></button>' +   /* [B10] تعادل بالتوافق — مصادقة الطرفين */
          '<button class="dama-mini dama-round dm-resign" onclick="damaResign()" title="' + T('dama.resignBtn') + '" aria-label="' + T('dama.resignBtn') + '"><svg class="dm-ico" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M6.2 3.1a1.05 1.05 0 0 1 1.05 1.05v15.7a1.05 1.05 0 0 1-2.1 0V4.15A1.05 1.05 0 0 1 6.2 3.1Z" fill="currentColor"/><path d="M8.5 4.4h8.6c1.25 0 1.95 1.45 1.2 2.42l-2.03 2.7 2.03 2.7c.75.97.05 2.42-1.2 2.42H8.5c-.6 0-1.08-.48-1.08-1.08V5.48c0-.6.48-1.08 1.08-1.08Z" fill="currentColor"/></svg></button>' +
        '</div>' +
