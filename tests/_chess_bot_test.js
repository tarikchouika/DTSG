...
/* [v2.28] شطرنج فردي ضد البوت عبر chessStartSolo — بوت يرد، تعادل، استسلام.
   (practiceVsAi تركتها سياسة «لا غرف مجانية» بلا رهان معطلة — المسار المحلي هو المعتمد) */
...
(async () => {
  ...
  const started = await p.evaluate(() => { chessSetBet(0); chessStartSolo(); return true; });
  ...
  ok('chessStartSolo: room vs bot started', !!ok1 && started !== false);
  ...
  ok('solo friendly is free (no bet)', gold0 === 50000 && await p.evaluate(() => ST.gold) === 50000);
