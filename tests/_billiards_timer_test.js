...
const els={};
function mkEl2(){return{style:{},classList:{add:()=>{},remove:()=>{},toggle:()=>{},contains:()=>false},textContent:""};}
function mkEl(){return{value:75,textContent:'',hidden:false,disabled:false,innerHTML:'',style:{},classList:{add:()=>{},remove:()=>{},toggle:()=>{},contains:()=>false},setAttribute:()=>{},getAttribute:()=>null,getBoundingClientRect:()=>({width:800,height:450,left:0,top:0}),getContext:()=>({scale:()=>{},clearRect:()=>{},save:()=>{},restore:()=>{},beginPath:()=>{},arc:()=>{},fill:()=>{},stroke:()=>{},moveTo:()=>{},lineTo:()=>{},closePath:()=>{},fillRect:()=>{},strokeRect:()=>{},translate:()=>{},rotate:()=>{},setLineDash:()=>{},createLinearGradient:()=>({addColorStop:()=>{}}),createRadialGradient:()=>({addColorStop:()=>{}}),ellipse:()=>{},quadraticCurveTo:()=>{},fillText:()=>{},measureText:()=>({width:10})}),addEventListener:()=>{},closest:()=>null,querySelector:()=>mkEl2(),style:{setProperty:()=>{}},querySelectorAll:()=>[],appendChild:()=>{},insertBefore:()=>{},contains:()=>false,_k:null};}
const doc={getElementById:(id)=>{if(!els[id])els[id]=mkEl();return els[id];},querySelectorAll:()=>[],createElement:()=>mkEl(),body:{classList:{add:()=>{},remove:()=>{}}},addEventListener:()=>{},removeEventListener:()=>{} };
