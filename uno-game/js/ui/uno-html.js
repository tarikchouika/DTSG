      ...
      '<div class="un-menuwrap">' +
        ...
        '<div class="un-menucard">' +
          ...
          '<div class="un-field" id="unTimerField">' +
            '<p class="un-flabel" data-un-i18n="ui.timer"></p>' +
            '<div class="un-seg" id="unTimerSeg">' +
              '<button type="button" class="un-segbtn on" data-v="0" data-un-i18n="ui.timerOff"></button>' +
              '<button type="button" class="un-segbtn" data-v="30" data-un-i18n="ui.sec30"></button>' +
              '<button type="button" class="un-segbtn" data-v="60" data-un-i18n="ui.sec60"></button>' +
              '<button type="button" class="un-segbtn" data-v="90" data-un-i18n="ui.sec90"></button>' +
              '<button type="button" class="un-segbtn" data-v="120" data-un-i18n="ui.sec120"></button>' +
              '<button type="button" class="un-segbtn" data-v="180" data-un-i18n="ui.sec180"></button>' +
              '<button type="button" class="un-segbtn" data-v="300" data-un-i18n="ui.sec300"></button>' +
            '</div>' +
          '</div>' +
        '</div>' +
    ...
    '<section class="un-screen" id="unGame">' +
      '<div class="un-table" id="unTable">' +
        ...
        '<div class="un-seat un-seat-top" id="unSeatTop">' +
          ...
          '<div class="un-plate" id="unPlate2"><span class="un-platebadge" id="unBadge2"></span><div class="un-av" id="unName2">…</div><span class="un-platecount" id="unCount2">7</span><span class="un-teamscore" id="unTeamScore2" hidden></span><span class="un-ptimer" id="unTimer2" hidden>⏱</span></div>' +
        '</div>' +
        '<div class="un-seat un-seat-right" id="unSeatRight">' +
          '<div class="un-stack" id="unStack1"></div>' +
          '<div class="un-plate" id="unPlate1"><span class="un-platebadge" id="unBadge1"></span><div class="un-av" id="unName1">…</div><span class="un-platecount" id="unCount1">7</span><span class="un-teamscore" id="unTeamScore1" hidden></span><span class="un-ptimer" id="unTimer1" hidden>⏱</span></div>' +
        '</div>' +
        '<div class="un-seat un-seat-left" id="unSeatLeft">' +
          '<div class="un-stack" id="unStack3"></div>' +
          '<div class="un-plate" id="unPlate3"><span class="un-platebadge" id="unBadge3"></span><div class="un-av" id="unName3">…</div><span class="un-platecount" id="unCount3">7</span><span class="un-teamscore" id="unTeamScore3" hidden></span><span class="un-ptimer" id="unTimer3" hidden>⏱</span></div>' +
        '</div>' +
        ...
        '<div class="un-handwrap" id="unHandWrap">' +
          '<div class="un-handplate" id="unHandPlate"><span class="un-platebadge" id="unBadge0"></span><div class="un-av" id="unName0">…</div><span class="un-platecount" id="unCount0">7</span><span class="un-teamscore" id="unTeamScore0" hidden></span><span class="un-ptimer" id="unTimer0" hidden>⏱</span></div>' +
