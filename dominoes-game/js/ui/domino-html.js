 ...
 *  • شاشة اللعب: طاولة جوخ أخضر تملأ الحاوية، قطع الخصم أعلى، وشارة اللاعب
 *    الرئيسية بجوار اليد والبنك أسفل اليسار في اللاندسكيب فقط [v2.57-DOMINO].
  ...
  '<div class="stage dm-stage" id="dmStage">' +
    ...
    '<section id="dmMenu" class="dm-screen dm-screen-active">' +
      ...
      '<div class="dm-menu-card">' +
        ...
        '<div class="dm-field" id="dmTimerField">' +
          '<div class="dm-flabel" data-i18n="ui.timer">مؤقت الدور</div>' +
          '<div class="dm-seg" id="dmTimerSeg">' +
            '<button type="button" class="dm-segbtn selected" data-timer="0" data-i18n="ui.timerOff">بدون</button>' +
            '<button type="button" class="dm-segbtn" data-timer="30" data-i18n="ui.sec30">30ث</button>' +
            '<button type="button" class="dm-segbtn" data-timer="60" data-i18n="ui.sec60">60ث</button>' +
            '<button type="button" class="dm-segbtn" data-timer="90" data-i18n="ui.sec90">90ث</button>' +
            '<button type="button" class="dm-segbtn" data-timer="120" data-i18n="ui.sec120">120ث</button>' +
            '<button type="button" class="dm-segbtn" data-timer="180" data-i18n="ui.sec180">180ث</button>' +
            '<button type="button" class="dm-segbtn" data-timer="300" data-i18n="ui.sec300">300ث</button>' +
          '</div>' +
        '</div>' +
