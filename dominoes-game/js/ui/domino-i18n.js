...
(function (root) {
  ...
  const T = {
    ...
    'dm.opp1':      ['الخصم 1', 'Adversaire 1', 'Opponent 1', 'الخصم 1'],
    'dm.opp2':      ['الخصم 2', 'Adversaire 2', 'Opponent 2', 'الخصم 2'],
    'dm.opp3':      ['الخصم 3', 'Adversaire 3', 'Opponent 3', 'الخصم 3'],
    'dm.p1':        ['اللاعب 1', 'Joueur 1', 'Player 1', 'اللاعب 1'],
    'dm.p2':        ['اللاعب 2', 'Joueur 2', 'Player 2', 'اللاعب 2'],
    'dm.p3':        ['اللاعب 3', 'Joueur 3', 'Player 3', 'اللاعب 3'],
    'dm.p4':        ['اللاعب 4', 'Joueur 4', 'Player 4', 'اللاعب 4'],
    'dm.playersCount': ['عدد اللاعبين', 'Nombre de joueurs', 'Number of players', 'شحال من لعّاب'],
    'dm.players.2': ['2 لاعبين', '2 joueurs', '2 players', '2 لعابة'],
    'dm.players.3': ['3 لاعبين', '3 joueurs', '3 players', '3 لعابة'],
    'dm.players.4': ['4 لاعبين', '4 joueurs', '4 players', '4 لعابة'],
