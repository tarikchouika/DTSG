...
( set -a; . "$ENV_FILE"; set +a
  NEEDED="TELEGRAM_BOT_TOKEN ADMIN_API_SECRET BINANCE_PAY_API_KEY BINANCE_PAY_SECRET_KEY
          ...
          CASH_PLUS_ACCOUNT CIH_ACCOUNT BINANCE_TRC20 VOUCHER_BOT_TOKEN"
  MISS=0
  for k in $NEEDED; do
    v="$(eval "printf '%s' \"\${$k:-}\"")"
